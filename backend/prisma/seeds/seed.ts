    ...
    try {
        ...
        const plans = [
            ...
            },
            {
                ...
                features: ['Tối đa 5 địa điểm (POI)', 'Thuyết minh đa ngôn ngữ', 'Quản lý thực đơn cơ bản'],
                maxPOI: 5,
                maxStore: 5,
            },
            {
                ...
                features: ['Tối đa 10 địa điểm (POI)', 'Thuyết minh đa ngôn ngữ', 'Quản lý thực đơn cơ bản'],
                maxPOI: 10,
                maxStore: 10,
            },
            {
